        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                <section class="content-header">
                    <h1>
                        APK
                        <small>Acknowledged APK Requests</small>
                    </h1>
                    <ol class="breadcrumb">
                                            ...
                                            @if ($acknowlegde)
                                                @foreach ($acknowlegde as $acknowlegdes)
                                                    <tr>
                                                        ...
                                                        <td>{{ $acknowlegdes->searchInput }}</td>
                                                        <td>{{ $acknowlegdes->recieverFullName }}</td>
                                                        <td>{{ $acknowlegdes->recieverBranch }}</td>
                                                        <td>{{ $acknowlegdes->recieverDepartment }}</td>
                                                        <td>{{ $acknowlegdes->OfficerID }}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
